...
//  gcc compiles "x / y" to "__aeabi_ddiv(x, y)"
...
x = -2205.1969; y = 0;          ri = __aeabi_dcmplt(x, y); TEST_ASSERT_EQUAL_INT( 1                  , ri );
}
...
x = -2205.1969; y = 0;          ri = __aeabi_dcmple(x, y); TEST_ASSERT_EQUAL_INT( 1                  , ri );
}
